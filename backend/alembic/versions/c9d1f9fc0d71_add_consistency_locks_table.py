"""add_consistency_locks_table

Revision ID: c9d1f9fc0d71
Revises: be61fa4a45fa
Create Date: 2026-01-18 19:41:34.987760
...
revision: str = 'c9d1f9fc0d71'
down_revision: Union[str, Sequence[str], None] = 'be61fa4a45fa'
...
def upgrade() -> None:
    ...
    op.create_table('consistency_locks',
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('project_id', sa.Integer(), nullable=False),
    ...
    sa.ForeignKeyConstraint(['project_id'], ['projects.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('project_id', 'asset_id', 'lock_type', name='uq_project_asset_lock')
    )
    op.create_index(op.f('ix_consistency_locks_id'), 'consistency_locks', ['id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_table('shots')
    op.drop_index(op.f('ix_consistency_locks_id'), table_name='consistency_locks')
    op.drop_table('consistency_locks')
